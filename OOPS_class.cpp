...
class car  //car is a blueprint.will come into existence wen an object is created corresponding to it
{
	int tyres;
public:
		char *name;
		...
		void setName(char *n)
		{
			...
			{
				delete []name;
				name=NULL;  //cant leave any line empty after deletion as it will display garbage value hence points to null
			}
